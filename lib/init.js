function parseVersion(json, semver, pjson, configPrivate) {
  ...
  if(pjson.isGitBuild) {
    console.log("NOTICE: You are running a git build of TriviaBot. This type of install may be unstable. For the latest stable version, check here: https://lakeys.net/triviabot/install.html");
  }
}
